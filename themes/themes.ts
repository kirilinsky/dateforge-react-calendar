...
export const THEMES_DATA: Record<string, string[]> = {
  ...
  aurora:    ["#07091a","#0b0e24","#3de0a0","#131838","#e0f9f0","#2a1f5a","#3de0a028","#2d3560","#ff5fa2","#00d4f5"],
  slate:     ["#ffffff","#f1f5f9","#475569","#e2e8f0","#0f172a","#cbd5e1","#47556920","#94a3b8","#e53935","#0ea5e9"],
  scarlet:   ["#ffffff","#fff5f5","#d92121","#ffe4e4","#1c0808","#f4b4b4","#d9212124","#c89898","#ff6b6b","#ff9800"],
};

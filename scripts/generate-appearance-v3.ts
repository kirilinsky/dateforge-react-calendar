/**
 * Generates `src/styles-v3/appearances.css` from the token records in
 * `src/styles-v3/appearances.ts` (the single source). One
 ...
 *
 * Run: npx tsx scripts/generate-appearance-v3.ts  (wired into `npm run build`).
 */
import { writeFileSync } from "node:fs";
import {
  APPEARANCE_TOKEN_TO_VAR,
  type AppearanceTokens,
} from "../src/styles-v3/appearance-tokens";
...
const lines: string[] = [
  ...
  " * Run: npx tsx scripts/generate-appearance-v3.ts",
  " * Source: src/styles-v3/appearances.ts (APPEARANCES).",
  " *",
...
writeFileSync("./src/styles-v3/appearances.css", lines.join("\n"));

console.log(`✓ ${names.length} appearances → src/styles-v3/appearances.css`);

/**
 * The palette source of truth: 28 hand-tuned families (light + dark), fed to
 * `scripts/generate-theme-v3.ts` which emits both `themes.css` and the named
 * `ThemeFamily` objects in `themes.ts`. Token keys are the v2 vocabulary; the
 * generator remaps them to v3 (`highlight→accent`, `accent→focusRing`).
 */
...
export const THEME_FAMILIES_DATA: Record<string, ThemeFamilyTokens> = {
  ...
  monsoon: {
    light: THEMES_DATA.monsoon,
    dark: COMPLEMENTARY_THEMES_DATA.monsoonDark,
  },
  industrial: {
    light: COMPLEMENTARY_THEMES_DATA.industrialLight,
    dark: THEMES_DATA.industrial,
  },
  snow: { light: THEMES_DATA.snow, dark: COMPLEMENTARY_THEMES_DATA.snowDark },
  eclipse: {
    light: COMPLEMENTARY_THEMES_DATA.eclipseLight,
    dark: THEMES_DATA.eclipse,
  },
  chalk: {
    light: THEMES_DATA.chalk,
    dark: COMPLEMENTARY_THEMES_DATA.chalkDark,
  },
  temporal: {
    light: COMPLEMENTARY_THEMES_DATA.temporalLight,
    dark: THEMES_DATA.temporal,
  },
  riso: { light: THEMES_DATA.riso, dark: COMPLEMENTARY_THEMES_DATA.risoDark },
  cyber: {
    light: COMPLEMENTARY_THEMES_DATA.cyberLight,
    dark: THEMES_DATA.cyber,
  },
  split: {
    light: THEMES_DATA.split,
    dark: COMPLEMENTARY_THEMES_DATA.splitDark,
  },
  aurora: {
    light: COMPLEMENTARY_THEMES_DATA.auroraLight,
    dark: THEMES_DATA.aurora,
  },
  graphite: {
    light: THEMES_DATA.graphite,
    dark: COMPLEMENTARY_THEMES_DATA.graphiteDark,
  },
  dracula: {
    light: COMPLEMENTARY_THEMES_DATA.draculaLight,
    dark: THEMES_DATA.dracula,
  },
  mint: { light: THEMES_DATA.mint, dark: COMPLEMENTARY_THEMES_DATA.mintDark },
  abyss: {
    light: COMPLEMENTARY_THEMES_DATA.abyssLight,
    dark: THEMES_DATA.abyss,
  },
};

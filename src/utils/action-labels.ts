...
export const DEFAULT_CURRENT_DAY_LABEL = "Current day, {day}";
export const DEFAULT_CURRENT_MONTH_LABEL = "Current month, {month}";
export const DEFAULT_CURRENT_YEAR_LABEL = "Current year, {year}";
...
export const DEFAULT_NEXT_DAY_LABEL = "Next day";
...
export const DEFAULT_PREVIOUS_DAY_LABEL = "Previous day";
